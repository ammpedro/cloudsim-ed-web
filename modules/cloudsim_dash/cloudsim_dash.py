    ...
    def post(self):
        ...
        if action == "launch":
            try:
                ...
                print ipynb_name
                ipynb_id = ''
                ipynb_dashurl = "http://"+simulator_data['sim_public_ip']+":8888/notebooks"
                print ipynb_dashurl
                data = urllib2.urlopen(ipynb_dashurl) 
                json_data=data.read()
                ...
                print splitscreen_url
                self.template_value['navbar'] = {}
                self.template_value['challenge_name'] = ipynb_name
...
class CloudsimTestLaunchHandler(BaseHandler):
    ...
    def get(self):
        ...
        try:
            ...
            self.template_value['navbar'] = {}
            self.template_value['alert'] = alert
            self.template_value['status'] = sim_data
            self.render('cloudlaunch.html')
        except:
            e = sys.exc_info()[0]
            print(e)
