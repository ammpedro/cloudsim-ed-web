...
#sys.path.append('modules/cloudsim_launch/cloudsim/bin')
#import create_cloudsim
...
class LaunchHandler(BaseHandler):
    ...
    def get(self):
        """Handles GET requests."""
        self.render('testlaunch.html')

    def post(self):
        create_cloudsim('ana.pedro@delasalle.ph', 'AKIAJLCEZWBYS23FMWKQ', '1InYfxpkuFCsOTbAr+iBuJ+50GAE6seyEeEtt85p', 'us-east-1b')
