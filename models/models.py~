...
class StudentProfileDAO(object):
    ...
    def add_new_student_for_current_user(cls, nick_name, country, age, cloudsim_ip, cloudsim_uname, cloudsim_passwd):
        ...
        cls._add_new_student_for_current_user(
            user.user_id(), user.email(), nick_name, country, age, cloudsim_ip, cloudsim_uname, cloudsim_passwd)

    @classmethod
    @db.transactional(xg=True)
    def _add_new_student_for_current_user(
        cls, user_id, email, nick_name, country, age, cloudsim_ip, cloudsim_uname, cloudsim_passwd):
...
class Student(BaseEntity):
    ...
    def add_new_student_for_current_user(cls, nick_name, country, age, cloudsim_ip, cloudsim_uname, cloudsim_passwd):
        StudentProfileDAO.add_new_student_for_current_user(
            nick_name, country, age, cloudsim_ip, cloudsim_uname, cloudsim_passwd)
