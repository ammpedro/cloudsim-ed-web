...
class PersonalProfile(BaseEntity):
    ...
    #cloudsim_ip = db.StringProperty(indexed=False)
    #cloudsim_uname = db.StringProperty(indexed=False)
    #cloudsim_passwd = db.StringProperty(indexed=False)
    #loudsim_simname = db.StringProperty(indexed=False)
...
class StudentProfileDAO(object):
    ...
    def _update_course_profile_attributes(
        ...
        cloudsim_uname=None, cloudsim_passwd=None, cloudsim_simname=None):
        ...
        if cloudsim_simname is not None:
            student.cloudsim_simname= cloudsim_simname
    ...
    def _update_attributes(
        ...
        email=None, legal_name=None, nick_name=None,
        date_of_birth=None, is_enrolled=None, final_grade=None,
        course_info=None, cloudsim_ip=None, cloudsim_uname=None, cloudsim_passwd=None, cloudsim_simname=None):
        ...
        if student:
            ...
            cloudsim_uname=cloudsim_uname, cloudsim_passwd=cloudsim_passwd, cloudsim_simname=cloudsim_simname)
    ...
    @classmethod
    def add_new_student_for_current_user(cls, nick_name, country, age, 
                cloudsim_ip, cloudsim_uname, cloudsim_passwd, cloudsim_simname):
        ...
        cls._add_new_student_for_current_user(
            user.user_id(), user.email(), nick_name, country, age, 
                    cloudsim_ip, cloudsim_uname, cloudsim_passwd, cloudsim_simname)

    @classmethod
    @db.transactional(xg=True)
    def _add_new_student_for_current_user(
        cls, user_id, email, nick_name, country, age, 
                    cloudsim_ip, cloudsim_uname, cloudsim_passwd, cloudsim_simname):
    ...
    def update_cloudsim(
        ...
        cls._update_attributes(
            ...
            cloudsim_simname=cloudsim_simname)
...
class Student(BaseEntity):
    ...
    cloudsim_uname = db.StringProperty(indexed=False)
    cloudsim_passwd = db.StringProperty(indexed=False)
    cloudsim_simname = db.StringProperty(indexed=False)
    ...
    @classmethod
    def edit_cloudsim_credentials(cls, new_ip, new_uname, new_pw, new_simname):
